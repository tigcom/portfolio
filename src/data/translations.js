...
const translations = {
  ...
  vi: {
    ...
    marketplace: {
      ...
      filterAll: 'Tất cả',
      filterEnterprise: 'Doanh nghiệp',
      filterBranding: 'Thương hiệu',
      filterEducation: 'Giáo dục',
      filterHospitality: 'Ẩm thực',
      filterRealEstate: 'Bất động sản',
      filterCorporate: 'Công ty',
      filterEcommerce: 'Thương mại điện tử',
      filterHealthcare: 'Y tế',
      demoBadge: 'Demo',
